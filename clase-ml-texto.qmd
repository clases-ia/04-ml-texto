...
[**Abril 2026**]{.big-par .center-justified}
...
::: {.callout-note .small-callout .fragment}
Notar que tradicionalmente la clase más pequeña es tomada como la positiva, pues es 
la más difícil o interesante de acertar (fraude bancario, enfermedad, etc).
:::
...
-   Ventajas:
    ...
    -   Es el **baseline clásico** en clasificación de texto: si tu modelo complejo no le gana, algo anda mal.
:::
