...
client._region_map["desarrollo"] = "us-east-1"
response = client.get_object("desarrollo",
  "ooee/clases_ia/datos/data_simpsons.parquet")
...
![](imagenes/simpsons3d.jpg){width=85%}
...
-   Si $t$ aparece en **todos** los documentos → $IDF \approx log(1)=0$ → el término $TF-IDF\approx 0$ .
-   Si $t$ es **exclusivo** de pocos documentos → $IDF$ alto → el término gana peso.
...
Les dejé un archivo `ciuo.parquet`. La idea es que entrenen un clasificador ciuo usando los conceptos
aprendidos en esta clase.
...
# Anexo 1 {visibility="uncounted"}

## Muestra 1 {visibility="uncounted"}

![](imagenes/muestra1.png){width=80%}

## Muestra 2 {visibility="uncounted"}

![](imagenes/muestra2.png){width=80%}

## Muestra 3 {visibility="uncounted"}

![](imagenes/muestra3.png){width=80%}
